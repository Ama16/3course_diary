...
class PREncoder(BaseEstimator, TransformerMixin):
    """Probability Ratio Encoding для категориальных данных.
    ...
    def fit(self, X, y): 
        ...
        data['not_target'] = np.where(data['not_target'] == 0, 0.000001, data['not_target'])
        data['answer'] = data[name]/ data['not_target']
